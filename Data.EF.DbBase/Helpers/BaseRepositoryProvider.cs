...
namespace ConnCar.Data.EF.BaseRepoDB.Helpers
{
    ...
    /// </remarks>
    public class BaseRepositoryProvider<TCtx> : IBaseRepositoryProvider<TCtx> where TCtx : DbContext
    {
        public BaseRepositoryProvider(BaseRepositoryFactories<TCtx> baseRepositoryFactories)
        {
            _baseRepositoryFactories = baseRepositoryFactories;
        ...
        public IRepository<T> GetRepositoryForEntityType<T>() where T : class
        {
            return GetRepository<IRepository<T>>(
                _baseRepositoryFactories.GetRepositoryFactoryForEntityType<T>());
        }
        ...
        /// of the injected <see cref="BaseRepositoryFactories"/>.
        /// </param>
        /// <remarks>
        ...
        /// </remarks>
        public virtual T GetRepository<T>(Func<TCtx, object> factory = null) where T : class
        {
        ...
        /// If null, gets factory from <see cref="_baseRepositoryFactories"/>.
        /// </param>
        /// <returns></returns>
        protected virtual T MakeRepository<T>(Func<TCtx, object> factory, TCtx dbContext)
        {
            var f = factory ?? _baseRepositoryFactories.GetRepositoryFactory<T>();
            if (f == null)
            {
        ...
        /// <summary>
        /// The <see cref="BaseRepositoryFactories"/> with which to create a new repository.
        /// </summary>
        /// <remarks>
        /// Should be initialized by constructor injection
        /// </remarks>
        private readonly BaseRepositoryFactories<TCtx> _baseRepositoryFactories;
