...
namespace GlobalVariable
{
    public class GVar
    {
        ...
        public const string JobMineBaseUrl = @"https://jobmine.ccol.uwaterloo.ca/psp/SS/";
        public const string LogInUrl = JobMineBaseUrl + @"?cmd=login&languageCd=ENG&sessionId=";
        public const string JobDetailBaseUrl = JobMineBaseUrl + @"EMPLOYEE/WORK/c/UW_CO_STUDENTS.UW_CO_JOBDTLS?UW_CO_JOB_ID=";
        public const string MenuUrl = JobMineBaseUrl + @"EMPLOYEE/WORK/h/?tab=DEFAULT";
        public const string JobInquiryUrlShort = JobMineBaseUrl + @"EMPLOYEE/WORK/c/UW_CO_STUDENTS.UW_CO_JOBSRCH.GBL";
        public const string JobInquiryUrl = JobMineBaseUrl + @"EMPLOYEE/WORK/c/UW_CO_STUDENTS.UW_CO_JOBSRCH.GBL?pslnkid=UW_CO_JOBSRCH_LINK&FolderPath=PORTAL_ROOT_OBJECT.UW_CO_JOBSRCH_LINK&IsFolder=false&IgnoreParamTempl=FolderPath%2cIsFolder";
        public const string StudentProfileUrl = JobMineBaseUrl +  @"EMPLOYEE/WORK/c/UW_CO_STUDENTS.UW_CO_STUDENT.GBL?pslnkid=UW_CO_STUDENT_LINK&FolderPath=PORTAL_ROOT_OBJECT.UW_CO_STUDENT_LINK&IsFolder=false&IgnoreParamTempl=FolderPath%2cIsFolder";
